        ...
        <div class="container">
            ...
            ?>
                        <div class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal"
                                data-dismiss="modal"> client Login / Register</a> </div>
                        <div class="login_btn"> <a href="admin/" class="btn btn-xs uppercase" data-toggle="modal"
                                data-dismiss="modal">Admin login</a> </div>
                        <?php } else {

              echo "Lease with ease.";
            } ?>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navigation">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="index.php">Calibre Auto Lease</a> </li>
