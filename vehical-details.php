...
if (isset($_POST['submit'])) {
  ...
  if ($lastInsertId) {
    echo "<script>alert('Booking successfull.Admin will contact you shorty');</script>";
  } else {
                        ...
                        <form method="post">
                            <div class="form-group">
                                <input type="text" class="form-control " placeholder="From Date(dd/mm/yyyy)"
                                    name="fromdate" id='adate' required="true">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control " placeholder="to Date(dd/mm/yyyy)" name="todate"
