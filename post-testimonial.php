    ...
    <section class="user_profile inner_pages">
        <div class="container">
            <div class="user_profile_info gray-bg padding_4x4_40">
                <div class="upload_user_logo"> <img src="assets/images/Auto.jpg" alt="image">
                </div>
                        ...
                        <div class="profile_wrap">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Share your thoughts here with us</label>
                                ...
                                <div class="form-group">
                                    <button type="submit" name="submit" class="btn">Submit <span class="angle_arrow"><i
